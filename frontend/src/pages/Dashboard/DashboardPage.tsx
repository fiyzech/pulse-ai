        ...
        <div className={`relative w-full xl:w-[831px] mb-[24px] transition-all ${isOpen ? "z-50" : "z-0"}`}>
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2">
            <div className="p-[1px] rounded-[28px] bg-[linear-gradient(90deg,rgba(82,46,139,0.32),rgba(179,179,179,0.32))] shadow-[0_4px_20px_rgba(131,72,193,0.15)]">
              ...
              >
                <span className="text-[12px] leading-[15px] font-medium">{selected}</span>
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className={`transition-transform ${isOpen ? "rotate-180" : ""}`}>
                  <path d="M2.5 7.5L6 4L9.5 7.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </button>
            </div>
            {isOpen && (
            ...
            <div key={coin.symbol} className="h-[305px] w-full p-[1px] rounded-[28px] bg-[linear-gradient(90deg,rgba(82,46,139,0.32),rgba(179,179,179,0.32))] shadow-[0_20px_70px_rgba(131,72,193,0.10),0_8px_25px_rgba(0,0,0,0.35)] transition-all duration-500 ease-out hover:shadow-[0_20px_80px_rgba(131,72,193,0.4),0_8px_25px_rgba(0,0,0,0.5)] hover:-translate-y-1">
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-6 pl-6">
                  ...
                  <div>
                    <h3 className="text-[16px] font-semibold text-white leading-tight">{coin.name}</h3>
                    <p className="text-[13px] text-white">{coin.symbol}</p>
                  </div>
                </div>
                <div className="pl-6 mt-[28px]">
                  <p className="font-montserrat text-[12px] leading-[16px] text-white mb-[12px]">Ціна ({timeLabelMap[selected]})</p>
                  <div className="flex items-baseline gap-2">
                    <span className="font-montserrat text-[28px] font-medium leading-none text-white">98.432</span>
                    <span className="font-montserrat text-[14px] font-medium text-white">USDT</span>
                  </div>
                </div>
                <div className="pl-6 mt-[12px]">
                  <div className="flex items-center gap-1 font-montserrat text-[12px] leading-[16px]">
                    <span className="text-white">Зміна:</span>
                    <span className={coin.symbol === "USDT" ? "text-[#FF4E4E]" : "text-[#24FF7A]"}>{coin.symbol === "USDT" ? "-2.45%" : "+2.45%"}</span>
                  </div>
                </div>
                <div className="absolute bottom-0 left-0 w-full h-[80px] opacity-50"><div className="w-full h-full bg-gradient-to-t from-[#7c3aed]/10 to-transparent" /></div>
              </div>
            </div>
          ))}
            ...
            <div className="relative flex h-full min-h-[368px] w-full flex-col overflow-hidden rounded-[28px] bg-[#050506] p-[24px]" style={{ backgroundImage: "url('/bgTelegramDashboard.png')", backgroundSize: "200%", backgroundPosition: "center" }}>
              <div>
                <div className="mb-[40px] flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
                  <div className="flex h-[24px] w-[24px] shrink-0 items-center justify-center"><img src="/logo-crypro-pulse.svg" alt="CryptoPulse" className="h-full w-full object-contain" /></div>
                  <div className="text-[16px] tracking-wide"><span className="font-light text-white">Crypto</span><span className="font-medium bg-gradient-to-r from-[#ceafef] to-[#9a64d4] bg-clip-text text-transparent">Pulse</span></div>
                </div>
                <h3 className="mb-[13px] text-[18px] font-semibold text-white leading-[22px]">Отримуй алерти<br />в телеграм боті</h3>
                <p className="h-[45px] font-montserrat text-[12px] text-white">Підключи Telegram, щоб миттєво отримувати сповіщення про свої алерти та ринкові зміни.</p>
              </div>
              <div className="mt-auto flex flex-col gap-[16px] pt-[20px]">
                <button onClick={() => navigate("/settings")} className="flex h-[44px] w-[213px] items-center justify-center rounded-[28px] bg-gradient-to-r from-[#2C1969] via-[#8348C1] to-[#C38BFF] text-[14px] font-medium leading-[20px] text-white transition-transform hover:scale-105">Підключити Telegram</button>
                <button className="group relative flex h-[44px] w-[213px] items-center justify-center rounded-[28px] text-[14px] font-medium leading-[20px] text-white transition-transform hover:scale-105">
                  <svg className="absolute inset-0 h-full w-full pointer-events-none" xmlns="http://www.w3.org/2000/svg"><rect x="1" y="1" width="211" height="42" rx="21" fill="none" stroke="url(#gradient-border)" strokeWidth="1.5" /><defs><linearGradient id="gradient-border" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#2C1969" /><stop offset="50%" stopColor="#8348C1" /><stop offset="100%" stopColor="#C38BFF" /></linearGradient></defs></svg>
        ...
        <div className="w-full max-w-[1116px] h-[354px] p-[1px] rounded-[28px] bg-[linear-gradient(90deg,rgba(82,46,139,0.32),rgba(179,179,179,0.32))] shadow-[0_20px_70px_rgba(131,72,193,0.10),0_8px_25px_rgba(0,0,0,0.35)] transition-all duration-500 ease-out hover:shadow-[0_20px_100px_rgba(131,72,193,0.3),0_8px_25px_rgba(0,0,0,0.4)]">
          <div className="relative flex h-full w-full items-start justify-center rounded-[28px] bg-[#050506]">
            ...
            <div className="absolute left-[24px] top-[24px] flex flex-col">
              ...
              <p className="h-[16px] text-[12px] leading-[16px] font-light text-white">Поточна ціна</p>
              <div className="h-[8px]" />
              ...
              <div className="relative h-full w-full rounded-[28px] bg-[#050506]">
                ...
                <div className="absolute right-[24px] top-[24px] z-20">
                  <div className="relative p-[1px] rounded-[28px] bg-[linear-gradient(90deg,rgba(82,46,139,0.32),rgba(179,179,179,0.32))]">
                    <button onClick={() => setIsPeriodOpen(!isPeriodOpen)} className="flex h-[36px] w-[86px] items-center justify-center gap-2 rounded-[28px] bg-[#050506] text-white transition-all hover:bg-white/5">
                      ...
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className={`transition-transform ${isPeriodOpen ? "rotate-180" : ""}`}><path d="M2.5 7.5L6 4L9.5 7.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" /></svg>
                    </button>
                    {isPeriodOpen && (
                      <div className="absolute right-0 top-[44px] z-50 w-[86px] p-[1px] rounded-[20px] bg-[linear-gradient(90deg,rgba(82,46,139,0.32),rgba(179,179,179,0.32))]">
                        <div className="bg-[#050506] rounded-[20px] p-[6px]">
                          {timeOptions1.map((option) => (
                            <button key={option} onClick={() => { setPeriodSelected(option); setIsPeriodOpen(false); }} className="w-full rounded-[12px] px-2 py-1.5 text-[12px] text-white/80 transition-all hover:bg-white/10 hover:text-white">{option}</button>
                          ))}
                        </div>
                      </div>
                    )}
                ...
                <div className="absolute left-[24px] top-[86px] w-[506px]">
                  <div className="relative h-[24px] w-full">
                    ...
                    <div className="absolute left-0 top-[12px] h-[1px] bg-gradient-to-r from-white/40 via-[#a855f7]/70 to-[#7c3aed]/80 transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)]" style={{ width: `${positionPercent}%` }} />
                    {timeline.map((item, index) => { const tickPosition = (index / (timeline.length - 1)) * 100; return <div key={item} className="absolute top-[6px] h-[12px] w-[1px] bg-white/20" style={{ left: `${tickPosition}%`, transform: "translateX(-50%)" }} />; })}
                    <div className="absolute top-[12px] h-[10px] w-[10px] rounded-full bg-[#8B5CF6] transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]" style={{ left: `${positionPercent}%`, transform: "translate(-50%, -45%)" }} />
                  </div>
                  <div className="relative mt-[8px] h-[14px] w-full text-[12px] text-white">
                    {timeline.map((item, index) => { let labelPosition = (index / (timeline.length - 1)) * 100; if (index === 0) labelPosition = 0; if (index === timeline.length - 1) labelPosition = 100.4; return <span key={item} className="absolute top-0 whitespace-nowrap" style={{ left: `${labelPosition}%`, transform: index === 0 ? "translateX(0)" : index === timeline.length - 1 ? "translateX(-100%)" : "translateX(-50%)" }}>{item}</span>; })}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-[80px] gap-y-[24px]">
              {[
                ...
                <div key={index} className="flex flex-col gap-[8px] min-h-[82px] cursor-pointer p-3 -mx-3 -my-2 rounded-[16px] transition-all duration-300 hover:bg-white/5">
                  ...
                  <p className="font-montserrat text-[16px] font-medium leading-[22px] text-white line-clamp-2">{news.title}</p>
                </div>
              ))}
            </div>
